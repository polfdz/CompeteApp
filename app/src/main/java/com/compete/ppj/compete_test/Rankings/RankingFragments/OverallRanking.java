...
public class OverallRanking  extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_overall_ranking, container, false);
        return rootView;
    }
    @Override
    public void onStart() {
        ...
        listView = (ListView) getActivity().findViewById(R.id.listViewOverallRanking);
            ...
            switch (conn) {
                case 200:
                    ...
                    for(int i = 0 ; i < jRanking.length(); i++)
                    {
                        ...
                        if(user_country.equals("null") || user_country.equals("buh") || user_country.equals("") || user_country.equals(null)){
